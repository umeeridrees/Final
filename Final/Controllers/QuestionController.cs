...
namespace Final.Controllers
{
    ...
    public class QuestionController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="q_id,statement,op1,op2,op3,op4,answer,test_id")] Question question)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="q_id,statement,op1,op2,op3,op4,answer,test_id")] Question question)
        {
            if (ModelState.IsValid)
            {
